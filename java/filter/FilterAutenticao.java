...
public class FilterAutenticao implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		HttpSession session = req.getSession(); //pegar sessão criada o servlet
		
		String usuarioLogado = (String) session.getAttribute("usuario"); //pegar usuário da sessão
		...
		if (usuarioLogado == null  && 
			...
			chain.doFilter(request, response); //passando a requisição do usuário para frente
		}
